...
#ifndef ENG_UTILITIES_TCONTAINER
...
class Tcontainer
     ...
     ~Tcontainer();
      ...
      inline obj*   get(uint32 id);       // Returns element pointer or NULL
      ...
      inline obj*   remove(uint32 id);    // Removes element from container without deleting it from memory. Pointer to element or NULL is returned
