...
Pipeline* MetalDevice::createPipeline(const PipelineState& pipelineState)
{
    PipelineMTL* pipeline = nullptr;
    ...
    const PipelineLayoutMTL*     layout         = pipelineState.pipelineLayout ? reinterpret_cast<PipelineLayoutMTL*>(pipelineState.pipelineLayout)
                                                                               : reinterpret_cast<PipelineLayoutMTL*>(defaultState->pipelineLayout);
