...
class Interface
{
    ...
    /// needs to have internal state per CPU core or thread using it. This method
    /// shouldn't be used for manual distribution of general tasks. Scheduler will
    /// optimally distribute submitted tasks, so use run() method instead.
