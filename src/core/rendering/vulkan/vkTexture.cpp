...
Heap* TextureVK::parent(void) const
{
    return heap;
}

TextureView* TextureVK::view(void)
{
    TextureViewVK* result = nullptr;
...
TextureView* TextureVK::view(const TextureType _type,
    const Format _format,
    const uint32v2 _mipmaps,
    const uint32v2 _layers)
{
    TextureView* result = nullptr;
...
TextureViewVK::TextureViewVK(TextureVK& parent,
...
Texture& TextureViewVK::parent(void) const
{
    return texture;
}
