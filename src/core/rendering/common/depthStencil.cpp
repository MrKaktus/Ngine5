...
//
// Legend:
// S - Stencil    F - Front facing
// D - Depth      B - Back facing
// 
// "-" - Stencil/Depth test failed
// "+" - Stencil/Depth test passed
// 
// RM    - Read Mask
// WM    - Write Mask
// Ref   - Reference value
// bound - min/max depth bounds
// 
// static  - state is static, part of PSO
// dynamic - state is dynamic, can be changed
//           TODO: Clear determination of changing granularity (per-encoder, per-draw-call? etc.)
// 
...
// readMask        Shared - D3D12_DEFAULT_STENCIL_READ_MASK  (0xFF) | 0xFFFF  0xFFFF    |  ?    ?  |
// writeMask       Shared - D3D12_DEFAULT_STENCIL_WRITE_MASK (0xFF) | 0xFFFF  0xFFFF    |  ?    ?  |
//
