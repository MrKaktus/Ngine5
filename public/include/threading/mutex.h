...
class cachealign Spinlock : private SharedAtomic, NonCopyable
{
    public:
    Spinlock() : SharedAtomic() {};
   ~Spinlock() { unlock(); }; // It shouldn't matter at this point. It may keep application alive even if it reads memory after release.
