...
PipelineD3D12::PipelineD3D12(
        ...
        const PipelineLayoutD3D12* _layout) :
    gpu(_gpu),
    handle(_handle),
    layout(_layout),
...
Pipeline* Direct3D12Device::createPipeline(const PipelineState& pipelineState)
{
    PipelineD3D12* result = nullptr;
    ...
    const PipelineLayoutD3D12*     layout        = pipelineState.pipelineLayout ? reinterpret_cast<PipelineLayoutD3D12*>(pipelineState.pipelineLayout)
                                                                                : reinterpret_cast<PipelineLayoutD3D12*>(defaultState->pipelineLayout);
    ...
    {
        result = new PipelineD3D12(this, pipeline, layout);
