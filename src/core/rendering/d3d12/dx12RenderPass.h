...
{
    public:
    // Referenced views not their parent textures cannot be released when Framebuffer is used by GPU
    const TextureViewD3D12* colorHandle[8];
    const TextureViewD3D12* resolveHandle[8];
    const TextureViewD3D12* depthHandle;
