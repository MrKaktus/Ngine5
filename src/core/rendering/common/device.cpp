...
CommonGraphicAPI::CommonGraphicAPI() :
    ...
    GraphicAPI()
{
    // Windows OS - Windowing System Query (Graphics API Independent)
    //---------------------------------------------------------------
...
// TODO: This static function should be in .mm file if we include Metal headers !!!
