...
namespace en
{
 ...
 //     VK_FORMAT_R64G64B64A64_SFLOAT        ,   // VertexFormat::RGBA_64_f
 //      
 ...
 //        
 //     // TODO: Do we want to expose all that legacy fixed point formats ?
 //          
 //
 //     // Vertex Fetch formats deliberately not supported:
 //     //  
