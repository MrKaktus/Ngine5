...
set PATH_OPENXR=.\..\middleware\openxr_loader_windows\x64\bin
...
if exist ".\..\bin\win32\Debug\Ngine5dbg.lib" (
   ...
   copy %PATH_OPENXR%\openxr_loader.dll .\..\public\bin\win32\Debug\openxr_loader.dll
...
if exist ".\..\bin\win32\Release\Ngine5.lib" (
   ...
   copy %PATH_OPENXR%\openxr_loader.dll .\..\public\bin\win32\Release\openxr_loader.dll
...
if exist ".\..\bin\win64\Debug\Ngine5dbg.lib" (
   ...
   copy %PATH_OPENXR%\openxr_loader.dll .\..\public\bin\win64\Debug\openxr_loader.dll
...
if exist ".\..\bin\win64\Release\Ngine5.lib" (
   ...
   copy %PATH_OPENXR%\openxr_loader.dll .\..\public\bin\win64\Release\openxr_loader.dll
